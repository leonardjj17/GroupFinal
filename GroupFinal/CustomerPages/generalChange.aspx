...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        ...
        <asp:RegularExpressionValidator ID="validatorPhone" runat="server" ControlToValidate="txtChangedValue" CssClass="alert-danger" Display="Dynamic" ErrorMessage="Must enter a valid phone number" Enabled="False" ValidationExpression="^\(?\d{3}\)?[- ]?\d{3}[- ]?\d{4}$"></asp:RegularExpressionValidator>
        <asp:RegularExpressionValidator ID="validatorZip" runat="server" ControlToValidate="txtChangedValue" CssClass="alert-danger" Display="Dynamic" Enabled="False" ErrorMessage="Must enter a valid zip code" ValidationExpression="\d{5}(-\d{4})?"></asp:RegularExpressionValidator>
    </p>
    <p>
        &nbsp;&nbsp;&nbsp;&nbsp;
